...
CUDA_VISIBLE_DEVICES=0 python inference.py \
  ...
  --validation_reference_path="/workspace/StableAvatar/examples/case-1/reference.png" \
  --validation_driven_audio_path="/workspace/StableAvatar/examples/case-1/audio.wav" \
